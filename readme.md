This is code for the webapp deployed. There will be another version of code for this same project but there we will just the build file of the react app in the public folder there.
